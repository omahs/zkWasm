...
impl<F: FieldExt> EventTableCellAllocator<F> {
    ...
    pub(crate) fn constraint_u64_with_flag_bit_cell<const POS: usize>(
        &mut self,
        constraint_builder: &mut ConstraintBuilder<F>,
    ...
    pub(crate) fn constraint_u64_with_flag_bit_cell_dyn(
        &mut self,
        constraint_builder: &mut ConstraintBuilder<F>,
        value: AllocatedU64Cell<F>,
        is_i32: impl Fn(&mut VirtualCells<'_, F>) -> Expression<F> + 'static,
    ...
    pub(crate) fn constraint_u64_with_flag_bit_cell_dyn_sign(
        &mut self,
        constraint_builder: &mut ConstraintBuilder<F>,
        is_i32: impl Fn(&mut VirtualCells<'_, F>) -> Expression<F> + 'static,
        is_sign: impl Fn(&mut VirtualCells<'_, F>) -> Expression<F> + 'static,
